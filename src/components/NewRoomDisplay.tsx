	...
	return (
		<div className='w-full flex flex-col items-center gap-16 animate-fade-in-500'>
			<div className='w-full max-w-[48rem] flex flex-col items-center justify-center gap-12'>
				<h2 className='font-bold text-gray-200 text-3xl'>{hostName}'s New Room URL</h2>
				<div className='flex flex-col items-center justify-center'>
					...
					<span className='text-gray-200 font-mono text-lg pb-6'>{roomUrl}</span>
					...
					>
						{hideGoLink ? 'Copy Room URL to Clipboard' : 'URL Copied to Clipboard!'}
					</button>
				</div>
			</div>
			<div className='h-10'>
